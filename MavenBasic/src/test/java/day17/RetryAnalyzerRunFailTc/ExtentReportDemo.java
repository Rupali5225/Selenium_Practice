...
public class ExtentReportDemo {
	...
	public void getResult(ITestResult result){
		if(result.getStatus() == ITestResult.FAILURE){  //ITestResult = after every method it will check every methods result and print according to that its log
			//if fail then = if block else else
